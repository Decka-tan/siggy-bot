...
const sovereignQuips: Quip[] = [
  ...
  { mood: "neutral", text: "With safe defaults (schedulerGas 400k + frequency 2000), 0.1 RIT funds a full 5-wakeup schedule loop spanning ~50 minutes. Escrow refills keep it alive." },
